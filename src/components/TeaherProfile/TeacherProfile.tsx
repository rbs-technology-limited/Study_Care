  ...
  return (
    <section className="container-lg mx-auto px-4 md:px-16 py-8">
      ...
      <div className="w-full flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-3 justify-center gap-2 my-5 text-gray-600 text-sm w-full lg:w-9/12">
          {/* left side */}
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="col-span-1 sm:block md:hidden">
              <p className="font-bold p-3 text-gray-800 dark:text-white border-[0.093rem] rounded-sm border-button-teal">
                ফেরদৌস45
              </p>
            </div>
