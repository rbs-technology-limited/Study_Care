...
const LessonTasksSummary = () => {
  ...
  return (
    <section>
      <div className="w-full p-3 bg-gray-50 dark:bg-transparent text-sm text-gray-600 dark:text-white border rounded flex flex-col md:flex-row justify-between items-center gap-2">
