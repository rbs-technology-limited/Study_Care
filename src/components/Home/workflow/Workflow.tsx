                ...
                <div className='flex flex-wrap gap-4  justify-center items-center px-4'>
                    {
                        workflowData.map((item, index) => (
                            ...
                            >
                                <div
                                    className="flex justify-center items-center dark:bg-[#1D1D1D] bg-white rounded-lg p-4 border-solid border-2 border-sky-500 hover:border-green-400 hover:cursor-pointer"
                                >
                                    <h1
                                        className="dark:text-[#E4E4E7] text-[#181818] text-[1.1rem] font-semibold text-center px-4 py-2"
                                    >
                                        {item.title}
                                    </h1>
                                </div>
