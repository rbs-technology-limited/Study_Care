              ...
              >
                <p
                  className={`text-xl font-normal text-center italic
                                    ...
                                    ${
                                      init?.activeIndex + 1 === review.id
                                        ? "dark:text-[#868686] text-[#535353]"
                                        : " text-[#CDCDCD] dark:text-[#868686]"
                                    }
                                           `}
                >
                  {review?.review_text}
